...
class WizardTest {
    ...
    void testGetRace() {
        Wizard w = new Wizard(Race.ELF, "Wizard", 10, 15, 12, 15, 10, new ArrayList<Item>(), new NoWeapon(),new ArrayList<WeaponBase>());
    ...
    void testGetHitPoints() {
        ...
        Wizard w2 = new Wizard(Race.ELF, "Wizard", 10, 15, 10, 15, 10, new ArrayList<Item>(), new NoWeapon(),new ArrayList<WeaponBase>());
    ...
    void testGetStatModifier() {
        Wizard w = new Wizard(Race.ELF, "Wizard", 10, 12, 14, 16, 8, new ArrayList<Item>(), new NoWeapon(),new ArrayList<WeaponBase>());
